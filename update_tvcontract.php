...
<select name="newCredit"><?php printQueryToOptionList("select tvcontract.creditId,fullName from tvcontract join credit using(creditId) group by tvcontract.creditId"); ?></select>
