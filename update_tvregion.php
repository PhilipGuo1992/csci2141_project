...
<select name="oldCredit"><?php printQueryToOptionList("select region_regionId,regionName from tvregion tvr join region r on r.regionId = tvr.region_regionId;"); ?></select>
